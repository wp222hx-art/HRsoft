      ...
      <div className="flex items-end justify-between">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-white">{meta.cn}</h1>
            {meta.killer && (
          ...
          <div className="mt-1 text-xs text-slate-400">{meta.tagline}</div>
        </div>
        <Link href="/sme" className="text-xs text-nova-300 hover:text-nova-200">← 返回 Smart Hub</Link>
      </div>
